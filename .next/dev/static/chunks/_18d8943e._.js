...
"[project]/src/features/vocabulary/pages/MyWordlistsPage.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MyWordlistsPage() {
    ...
    const [bookmarkedIds, setBookmarkedIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Set());
    ...
    const fetchBookmarks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MyWordlistsPage.useCallback[fetchBookmarks]": async ()=>{
            if (!user) return;
            try {
                const token1 = await getToken();
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$reviewCardsApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchReviewCards"])(token1, {
                    limit: 1000
                });
                const ids = new Set(data.cards.map({
                    "MyWordlistsPage.useCallback[fetchBookmarks]": (c)=>c.cardId
                }["MyWordlistsPage.useCallback[fetchBookmarks]"]));
    ...
    const loadCards = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MyWordlistsPage.useCallback[loadCards]": async (cursor = null)=>{
            if (!user) return;
            try {
                if (cursor) {
                    setLoadingMore(true);
                ...
                setError(null);
                const token1 = await getToken();
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$progressApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWordlist"])(token1, learningLang, {
                    limit: 50,
                    cursor
                });
                if (cursor) {
                    setCards({
                        "MyWordlistsPage.useCallback[loadCards]": (prev)=>[
                                ...prev,
                                ...data.cards
                            ]
                    }["MyWordlistsPage.useCallback[loadCards]"]);
                } else {
                    setCards(data.cards);
                }
    ...
    const handleBookmark = async (card)=>{
        ...
        try {
            if (isBookmarked) {
                const token1 = await getToken();
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$reviewCardsApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeFromReview"])(token1, cardId);
                ...
                // ADD bookmark
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$reviewCardsApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addToReview"])(token, {
    ...
    const handleDeleteLearned = async (cardId)=>{
        ...
        if (!window.confirm("Are you sure you want to remove this word from your learned list?")) {
            return;
        }
        setDeletingId(cardId);
        try {
            const token1 = await getToken();
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$progressApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteLearnedCard"])(token1, cardId);
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                    ...
                    fileName: "[project]/src/features/vocabulary/pages/MyWordlistsPage.tsx",
                    lineNumber: 176,
                    columnNumber: 11
                }, this)
            }, void 0, false, {
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: "Please sign in to view your review words."
                }, void 0, false, {
                    fileName: "[project]/src/features/vocabulary/pages/MyWordlistsPage.tsx",
                    lineNumber: 187,
                    columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-gray-500 dark:text-slate-400",
                                        children: cards.length > 0 ? `${cards.length} word${cards.length !== 1 ? "s" : ""} learned` : "Words you learn will appear here"
                                    }, void 0, false, {
                                        fileName: "[project]/src/features/vocabulary/pages/MyWordlistsPage.tsx",
                                        lineNumber: 211,
                                        columnNumber: 13
                            ...
                            cards.length > 0 && !isLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: ()=>router.push("/vocabulary/lessons/review/wordlists/session"),
            ...
            !isLoading && !error && cards.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Complete lessons and save your progress to review the words you've learned."
                    }, void 0, false, {
                        fileName: "[project]/src/features/vocabulary/pages/MyWordlistsPage.tsx",
                        lineNumber: 262,
                        columnNumber: 11
            ...
            !isLoading && !error && cards.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                                        ...
                                        renderActions: ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        ...
                                                        disabled: isActionLoading,
                                                        className: `p-2 rounded-lg transition-colors disabled:opacity-50 ${isBookmarked ? "text-sky-500 bg-sky-50 dark:bg-sky-900/20" : "text-gray-400 hover:text-sky-500 hover:bg-sky-50 dark:hover:bg-sky-900/20"}`,
                                                        title: isBookmarked ? "Remove from Review" : "Add to Review",
                                                        children: isActionLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                                                            className: "w-5 h-5 animate-spin"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/features/vocabulary/pages/MyWordlistsPage.tsx",
                    ...
                    hasMore && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex justify-center p-4 border-t border-gray-100 dark:border-slate-700",
...
_s(MyWordlistsPage, "wZQSoBVyUfnLxo+1mKuqyCbzXDA=", false, function() {
    return [
...
_c = MyWordlistsPage;
var _c;
__turbopack_context__.k.register(_c, "MyWordlistsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_18d8943e._.js.map