...
"[project]/src/features/vocabulary/pages/CEFRLevelPage.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CEFRLevelPage() {
    _s1();
    const { level } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"])();
    ...
    const [progressMap, setProgressMap] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [bookmarkMap, setBookmarkMap] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    const [isRemoveAction, setIsRemoveAction] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CEFRLevelPage.useEffect": ()=>{
            async function loadCategories() {
                try {
                    setIsLoading(true);
                    setError(null);
                    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$vocabularyApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchCategoriesByLevel"])(level?.toUpperCase());
                    // Deduplicate by slug in case the API returns duplicates
                    const seen = new Set();
                    const unique = (data.categories || []).filter({
                        "CEFRLevelPage.useEffect.loadCategories.unique": (c)=>{
                            if (seen.has(c.slug)) return false;
                            seen.add(c.slug);
                            return true;
                        }
                    }["CEFRLevelPage.useEffect.loadCategories.unique"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CEFRLevelPage.useEffect": ()=>{
            async function loadProgress() {
                ...
                const progressPromises = categories.map({
                    "CEFRLevelPage.useEffect.loadProgress.progressPromises": async (category)=>{
                        try {
                            const token = await getToken();
                            const progress = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$progressApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLessonProgress"])(token, learningLang, level, category.slug);
                            return {
                                slug: category.slug,
                ...
                }["CEFRLevelPage.useEffect.loadProgress.progressPromises"]);
                const results = await Promise.all(progressPromises);
                const map = {};
                results.forEach({
                    "CEFRLevelPage.useEffect.loadProgress": (r)=>{
                        map[r.slug] = r.count;
                    }
                }["CEFRLevelPage.useEffect.loadProgress"]);
                setProgressMap(map);
            }
            loadProgress();
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CEFRLevelPage.useEffect": ()=>{
            async function loadBookmarkStatus() {
                if (!user || categories.length === 0) return;
                const bookmarkPromises = categories.map({
                    "CEFRLevelPage.useEffect.loadBookmarkStatus.bookmarkPromises": async (category)=>{
                        try {
                            const token = await getToken();
                            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$reviewCardsApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkCategoryBookmarked"])(token, level?.toUpperCase(), category.name);
                            return {
                                slug: category.slug,
                ...
                }["CEFRLevelPage.useEffect.loadBookmarkStatus.bookmarkPromises"]);
                const results = await Promise.all(bookmarkPromises);
                const map = {};
                results.forEach({
                    "CEFRLevelPage.useEffect.loadBookmarkStatus": (r)=>{
                        map[r.slug] = r.isBookmarked;
                    }
                }["CEFRLevelPage.useEffect.loadBookmarkStatus"]);
                setBookmarkMap(map);
            }
            loadBookmarkStatus();
        }
    ...
    const handleConfirm = async ()=>{
        ...
        try {
            if (isRemoveAction) {
                ...
                const token = await getToken();
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$reviewCardsApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["bulkRemoveFromReview"])(token, level?.toUpperCase(), selectedCategory.name);
                setBookmarkMap((prev)=>({
                        ...prev,
                ...
                const vocabData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$vocabularyApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchVocabulary"])({
                    level: level?.toUpperCase(),
                    category: selectedCategory.slug
                });
                if (vocabData.words && vocabData.words.length > 0) {
                    const token = await getToken();
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$reviewCardsApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["bulkAddToReview"])(token, level?.toUpperCase(), selectedCategory.slug, vocabData.words);
                    setBookmarkMap((prev)=>({
                            ...prev,
...
_s1(CEFRLevelPage, "tHihRXG58koB//iMIviOqjaq7Vw=", false, function() {
    return [
...
__turbopack_context__.k.register(_c2, "CEFRLevelPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_8113f0de._.js.map