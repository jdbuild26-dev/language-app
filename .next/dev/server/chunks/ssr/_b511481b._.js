...
"[project]/src/features/vocabulary/pages/MyWordlistsPage.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MyWordlistsPage() {
    ...
    const [bookmarkedIds, setBookmarkedIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(new Set());
    ...
    const fetchBookmarks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        if (!user) return;
        try {
            const token1 = await getToken();
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$reviewCardsApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchReviewCards"])(token1, {
                limit: 1000
            });
    ...
    // Fetch learned cards
    const loadCards = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (cursor = null)=>{
        if (!user) return;
        try {
            if (cursor) {
                setLoadingMore(true);
            ...
            setError(null);
            const token1 = await getToken();
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$progressApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getWordlist"])(token1, learningLang, {
                limit: 50,
                cursor
            });
            if (cursor) {
    ...
    const handleBookmark = async (card)=>{
        ...
        try {
            if (isBookmarked) {
                const token1 = await getToken();
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$reviewCardsApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["removeFromReview"])(token1, cardId);
                ...
                // ADD bookmark
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$reviewCardsApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addToReview"])(token, {
    ...
    const handleDeleteLearned = async (cardId)=>{
        ...
        try {
            const token1 = await getToken();
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$progressApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteLearnedCard"])(token1, cardId);
...
//# sourceMappingURL=_b511481b._.js.map