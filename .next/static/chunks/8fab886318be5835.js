...
to {
  ...
  animation: ${F} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Y=({toast:e})=>{let{icon:t,type:r,iconTheme:s}=e;return void 0!==t?"string"==typeof t?i.createElement(z,null,t):t:"blank"===r?null:i.createElement(X,null,i.createElement(O,{...s}),"loading"!==r&&i.createElement(W,null,"error"===r?i.createElement(D,{...s}):i.createElement(M,{...s})))},G=y("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
