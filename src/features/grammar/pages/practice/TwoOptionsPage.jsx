...
export default function TwoOptionsPage() {
  ...
  useEffect(() => {
    const fetchAndTransformQuestions = async () => {
      try {
        const data = await loadMockCSV("grammar/two_options.csv");
        ...
        const transformed = data.map((item) => {
          ...
          try {
            ...
            parsedOptions = ["True", "False"]; // Default fallback
          }
      ...
      >
        <div className="flex flex-col lg:flex-row items-center justify-center w-full max-w-7xl mx-auto px-4 py-6 gap-8 lg:gap-16 min-h-[60vh]">
          ...
          <div className="flex-1 w-full max-w-xl flex flex-col gap-8 justify-center">
            ...
            {/* Options - Large Buttons for 2 Options */}
              ...
              {currentQuestion?.options.map((option, index) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "group relative p-8 rounded-3xl border-2 text-center transition-all flex flex-col items-center justify-center gap-4 bg-white dark:bg-slate-800 shadow-lg min-h-[140px]",
                      "border-slate-200 dark:border-slate-700 hover:border-purple-300 dark:hover:border-purple-700 hover:shadow-xl hover:scale-105",
                      isSelected &&
                        !showFeedback &&
                        "border-purple-500 bg-purple-50 dark:bg-purple-900/10 ring-4 ring-purple-500/30 scale-105",
                      isCorrectHighlight &&
                        "border-green-500 bg-green-50 dark:bg-green-900/20 ring-4 ring-green-500/30 scale-105",
                      isWrongSelection &&
                        "border-red-500 bg-red-50 dark:bg-red-900/20 ring-4 ring-red-500/30 scale-105",
                    )}
                  >
                    <div
                      className={cn(
                    ...
                    <div>
                      <p
                        className={cn(
                          ...
                          isSelected && !showFeedback && "text-purple-700",
