...
import {
  ...
  LessonHeader,
  CompletionScreen,
} from "@/features/vocabulary/components/lesson-learn";
    ...
    return (
      <div className="fixed inset-0 z-[9999] bg-white dark:bg-slate-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-slate-400">Loading your reviews...</p>
        </div>
      </div>
    );
  }

  return <SrsLearnPageContent />;
}

function SrsLearnPageContent() {
